<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="lv2_2bzadaca._Default" %>
        ...
        <div class="row">
            ...
            <div class="col-xs-6 ">
                ...
                <asp:RequiredFieldValidator
                    ...
                    ValidationGroup="podatoci1"
                    runat="server"
                    ErrorMessage="Полето за Finki ID е задолжително!">
                </asp:RequiredFieldValidator>
        ...
        <div class="row">
            ...
            <div class="col-xs-4 ">
                ...
                <asp:RequiredFieldValidator
                    ...
                    ValidationGroup="podatoci1"
                    runat="server"
                    ErrorMessage="Внесете потврда на лозинката!">
